<?php
	...
	$product_delivery = $dbs->getDeliveries("");
...
<div class = "container">
	<div class = "row">
		<div class = "col-md-12" align = "center">
			<p style = "font-size:60px; text-align:center"> Product Delivery Data Management</p>
		</div>
	</div>
			...
			<div class = "col-md-4">
				<div class = "row">
					<div class = "form-group form-group-md">
						<div class = "col-md-2">
							<button class = "btn btn-success" id = "addProductDelivery">
								<i class = "fa fa-plus-circle"></i> NEW
							</button>
						</div>
						<div class = "col-md-8">
							<input type = "text" name = "search" id = "srchID" placeholder = "Type a few letters of the company name" class = "form-control input-md" value = "">
						</div>
					</div>
				</div>
				<div class = "row">
					<div class = "form-group form-group-md">
						<select name = "product_delivery" id = "product_delivery" value = "" size = "15" style = "width: 350px">
							<?php
								foreach($product_delivery as $row){
									if($row == "Empty"){
										echo "<option value = '0'> No delivery yet </option>";
										break;
									}
									$id = $row["delivery_code"];
									echo "<option value = '$id'>".$row['delivery_date']." - ".$row['company_name']."</option>";
								}
							?>
						</select>
					</div>
